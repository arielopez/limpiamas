...
<script type="text/javascript">
   ...
   nueva_compra_url = '<?php echo $fsc->nuevo_albaran_url;?>';
...
<form name="f_albaran" action="<?php echo $fsc->albaran->url();?>" method="post" class="form">
   ...
   <input type="hidden" name="proveedor" value="<?php echo $fsc->albaran->codproveedor;?>"/>
   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <ol class="breadcrumb" style="margin-bottom: 5px;">
               ...
               <li><a href="<?php echo $fsc->ppage->url();?>"><?php  echo FS_ALBARANES;?></a></li>
               <li>
               ...
               <li>
                  <a href="<?php echo $fsc->albaran->proveedor_url();?>"><?php echo $fsc->albaran->nombre;?></a>
               </li>
               <?php if( $fsc->proveedor_s ){ ?>

                  <?php if( $fsc->proveedor_s->nombre!=$fsc->albaran->nombre ){ ?>
            ...
            <p class="help-block">
               ...
               <span class="text-capitalize"><?php  echo FS_ALBARAN;?></span> creado por <a href="<?php echo $fsc->agente->url();?>"><?php echo $fsc->agente->get_fullname();?></a>.
               <?php }else{ ?>
      ...
      <div class="row">
         ...
         <div class="col-md-3 col-sm-12">
            <div class="form-group">
               ...
               <div class="input-group">
                  <input class="form-control" type="text" name="ac_proveedor" id="ac_proveedor" value="<?php echo $fsc->albaran->nombre;?>" placeholder="Buscar" autocomplete="off"/>
         ...
         <div class="col-md-3 col-sm-4">
            <div class="form-group">
               Núm. Proveedor:
               <input class="form-control" type="text" name="numproveedor" value="<?php echo $fsc->albaran->numproveedor;?>"/>
            </div>
         </div>
         <?php if( $fsc->albaran->ptefactura ){ ?>
            ...
            <div class="table-responsive">
                     ...
                     <tr id="linea_<?php echo $counter1;?>">
                        <td>
                           ...
                           <div class="form-control">
                              ...
                              <a target="_blank" href="index.php?page=compras_pedido&id=<?php echo $value1->idpedido;?>" title="ver <?php  echo FS_PEDIDO;?>">
               ...
               <table class="table table-hover">
                  ...
                  <tr>
                     ...
                     <td colspan="4" class="text-right warning"><b><?php echo $fsc->albaran->coddivisa;?>:</b></td>
                     <?php }else{ ?>
               ...
               <div class="row">
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nombre" value="<?php echo $fsc->albaran->nombre;?>" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <div class="form-group">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="f_buscar_articulos" name="f_buscar_articulos" action="<?php echo $fsc->url();?>" method="post" class="form">
               <input type="hidden" name="codproveedor" value="<?php echo $fsc->albaran->codproveedor;?>"/>
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="input-group">
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  Mensaje:
                  <textarea class="form-control" name="mensaje" rows="6">Buenos días, le adjunto mi <?php  echo FS_ALBARAN;?> <?php echo $fsc->albaran->codigo;?>.
