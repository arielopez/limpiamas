...
<script type="text/javascript">
   ...
   nueva_compra_url = '<?php echo $fsc->nuevo_pedido_url;?>';
...
<form name="f_pedido" action="<?php echo $fsc->pedido->url();?>" method="post" class="form">
   ...
   <input type="hidden" name="proveedor" value="<?php echo $fsc->pedido->codproveedor;?>"/>
   ...
   <div class="container-fluid">
         ...
         <div class="col-md-8 col-sm-8 col-xs-8">
            ...
            <!--div class="btn-group">
               ...
               <a class="btn btn-sm btn-info text-capitalize" href="<?php echo $fsc->pedido->albaran_url();?>">
                  <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver <?php  echo FS_ALBARAN;?>

               </a>
               <?php }elseif( $fsc->pedido->editable ){ ?>

               <a class="btn btn-sm btn-default" href="<?php echo $fsc->url();?>&aprobar=TRUE&petid=<?php echo $fsc->random_string();?>">
                  <span class="glyphicon glyphicon-paperclip"></span> &nbsp; Aprobar
               </a>
               <?php }else{ ?>

               <a class="btn btn-sm btn-warning" href="<?php echo $fsc->pedido->url();?>&desbloquear=TRUE">
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <ol class="breadcrumb" style="margin-bottom: 5px;">
               ...
               <li><a href="<?php echo $fsc->ppage->url();?>"><?php  echo FS_PEDIDOS;?></a></li>
               <li>
                  <a href="<?php echo $fsc->pedido->proveedor_url();?>"><?php echo $fsc->pedido->nombre;?></a>
               </li>
               <?php if( $fsc->proveedor_s ){ ?>

                  <?php if( $fsc->proveedor_s->nombre!=$fsc->pedido->nombre ){ ?>

                  <li>
                     <a href="#" onclick="alert('Proveedor conocido como: <?php echo $fsc->proveedor_s->nombre;?>')">
      ...
      <div class="row">
         ...
         <div class="col-md-3 col-sm-12">
            <div class="form-group">
               ...
               <div class="input-group">
                  <input class="form-control" type="text" name="ac_proveedor" id="ac_proveedor" value="<?php echo $fsc->pedido->nombre;?>" placeholder="Buscar" autocomplete="off"/>
         ...
         <div class="col-md-3 col-sm-4">
            <div class="form-group">
               Núm. Proveedor:
               <input class="form-control" type="text" name="numproveedor" value="<?php echo $fsc->pedido->numproveedor;?>"/>
            </div>
         </div>
         <?php if( $fsc->pedido->editable ){ ?>
      ...
      <div class="tab-content">
            ...
            <div class="table-responsive">
               ...
               <table class="table table-hover">
                  ...
                  <tr>
                     ...
                     <td colspan="4" class="text-right warning"><b><?php echo $fsc->pedido->coddivisa;?>:</b></td>
                     <?php }else{ ?>
               ...
               <div class="row">
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nombre" value="<?php echo $fsc->pedido->nombre;?>" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <div class="form-group">
         ...
         <?php $loop_var1=$fsc->extensions; $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
            ...
            <div role="tabpanel" class="tab-pane" id="ext_<?php echo $value1->name;?>">
               <iframe src="index.php?page=<?php echo $value1->from;?><?php echo $value1->params;?>&id=<?php echo $fsc->pedido->idpedido;?>" width="100%" height="600" frameborder="0"></iframe>
            </div>
            <?php } ?>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="f_buscar_articulos" name="f_buscar_articulos" action="<?php echo $fsc->url();?>" method="post" class="form">
               <input type="hidden" name="codproveedor" value="<?php echo $fsc->pedido->codproveedor;?>"/>
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="input-group">
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-group">
                  Email del proveedor:
                  <input class="form-control" type="text" name="email" value="<?php echo $fsc->proveedor_s->email;?>" autocomplete="off"/>
               </div>
               <div class="form-group">
                  Mensaje:
                  <textarea class="form-control" name="mensaje" rows="6">Buenos días, le adjunto mi <?php  echo FS_PEDIDO;?> <?php echo $fsc->pedido->codigo;?>.
