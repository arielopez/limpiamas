...
<ul class="nav nav-tabs" role="tablist">
   <li<?php if( $fsc->mostrar=='todo' ){ ?> class="active"<?php } ?>>
      <a href="<?php echo $fsc->url();?>&mostrar=todo">
         Todos los <?php  echo FS_PRESUPUESTOS;?>
   ...
   <table class="table table-hover">
      <thead>
         <tr>
            ...
            <?php if( $fsc->mostrar!='todo' ){ ?>
                ...
                <th class="text-right hidden-sm">Fecha Fin</th>
            <?php } ?>
      ...
      <tr class="clickableRow<?php if( $value1->status==1 ){ ?> success<?php }elseif( $value1->status==2 ){ ?> danger<?php }elseif( $value1->total<=0 ){ ?> warning<?php } ?>" href="<?php echo $value1->url();?>">
         ...
         <td>
            ...
            <a href="<?php echo $fsc->url();?>&codcliente=<?php echo $value1->codcliente;?>" class="cancel_clickable" title="Ver más <?php  echo FS_PRESUPUESTOS;?> de <?php echo $value1->nombrecliente;?>">[+]</a>
         </td>
         ...
         <td class="text-right hidden-sm hidden-md">
            <?php if( $value1->status==0 ){ ?><?php echo $value1->finoferta;?><?php }else{ ?>-<?php } ?>
      ...
      <tr class="warning">
         <td></td>
         <td colspan="7">Ningún <?php  echo FS_PRESUPUESTO;?> encontrado. Pulsa el botón <b>Nuevo</b> para crear uno.</td>
      </tr>
      <?php } ?>
