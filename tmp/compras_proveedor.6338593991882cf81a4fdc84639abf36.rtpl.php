...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $("#b_edit-form").click(function(){
         //event.preventDefault();
         $('input').prop("disabled", false);
         $('select').prop("disabled",false);
         $('textarea').prop("disabled",false);
         $('button').prop("disabled",false);// Element(s) are now enabled.
      });
   });
      ...
      <div class="col-lg-10 col-md-10 col-sm-9">
                  ...
                  <div class="container-fluid">
                     <div class="row">
                        <div class="col-sm-4">
                           <div class="form-group">
                              Nombre:
                              <input class="form-control" type="text" name="nombre" value="<?php echo $fsc->proveedor->nombre;?>" autocomplete="off" disabled/>
                        ...
                        <div class="col-sm-5">
                           <div class="form-group">
                              Razón social:
                              <input class="form-control" type="text" name="razonsocial" value="<?php echo $fsc->proveedor->razonsocial;?>" autocomplete="off"  disabled/>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              <?php  echo FS_CIFNIF;?>:
                              <input class="form-control" type="text" name="cifnif" value="<?php echo $fsc->proveedor->cifnif;?>" autocomplete="off"  disabled/>
                              <label>
                                 <input type="checkbox" name="acreedor" value="TRUE"<?php if( $fsc->proveedor->acreedor ){ ?> checked="checked"<?php } ?> disabled/>
                                 Es un <b>acreedor</b>
                     ...
                     <div class="row">
                        <div class="col-sm-2">
                           <div class="form-group">
                              Teléfono 1:
                              <input class="form-control" type="text" name="telefono1" value="<?php echo $fsc->proveedor->telefono1;?>" autocomplete="off"  disabled/>
                           </div>
                        </div>
                        <div class="col-sm-2">
                           <div class="form-group">
                              Teléfono 2:
                              <input class="form-control" type="text" name="telefono2" value="<?php echo $fsc->proveedor->telefono2;?>" autocomplete="off" disabled/>
                           </div>
                        </div>
                        <div class="col-sm-2">
                           <div class="form-group">
                              Fax:
                              <input class="form-control" type="text" name="fax" value="<?php echo $fsc->proveedor->fax;?>" autocomplete="off" disabled/>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
                              Email:
                              <input class="form-control email" type="email" name="email" value="<?php echo $fsc->proveedor->email;?>" autocomplete="off" disabled/>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group">
                              Web:
                              <input class="form-control web" type="text2" name="web" value="<?php echo $fsc->proveedor->web;?>" autocomplete="off" disabled/>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="codpago" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="coddivisa" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="regimeniva" disabled>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           Observaciones:
                           <textarea class="form-control" name="observaciones" rows="3" disabled><?php echo $fsc->proveedor->observaciones;?></textarea>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="panel-footer text-right">
                  <button class="btn btn-sm btn-primary" type="submit" onclick="this.disabled=true;this.form.submit();" disabled>
         ...
         <div id="panel_cuentasb" class="pseudotab_prov">
            ...
            <form action="<?php echo $fsc->url();?>#cuentasb" method="post" class="form">
               <input type="hidden" name="codcuenta" value="<?php echo $value1->codcuenta;?>" disabled/>
               <input type="hidden" name="codproveedor" value="<?php echo $value1->codproveedor;?>" disabled/>
               <div class="panel panel-info">
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-md-8">
                           <div class="form-group">
                              <input class="form-control" type="text" name="descripcion" value="<?php echo $value1->descripcion;?>" placeholder="Cuenta principal" autocomplete="off"  disabled/>
                           </div>
                        </div>
         ...
         <div id="panel_direcciones" class="pseudotab_prov">
            ...
            <form action="<?php echo $fsc->url();?>#direcciones" method="post" class="form">
               <input type="hidden" name="codproveedor" value="<?php echo $fsc->proveedor->codproveedor;?>"  disabled/>
               <input type="hidden" name="coddir" value="<?php echo $value1->id;?>" disabled/>
               <div class="panel panel-info">
                  <div class="panel-heading">
                  ...
                  <div class="panel-body">
                     ...
                     <div class="form-group col-lg-4 col-md-4 col-sm-4">
                        ...
                        <input type="text" name="provincia" value="<?php echo $value1->provincia;?>" id="ac_provincia" class="form-control" disabled/>
                     </div>
                     <div class="form-group col-lg-4 col-md-4 col-sm-4">
                        Ciudad:
                        <input class="form-control" type="text" name="ciudad" ID="ciudad" value="<?php echo $value1->ciudad;?>" disabled/>
                     </div>
                     <div class="form-group col-lg-3 col-md-3 col-sm-3">
                        Código Postal:
                        <input class="form-control" type="text" name="codpostal" value="<?php echo $value1->codpostal;?>" autocomplete="off" disabled/>
                     </div>
                     <div class="form-group col-lg-9 col-md-9 col-sm-9">
                        Dirección:
                        <input class="form-control" type="text" name="direccion" value="<?php echo $value1->direccion;?>" autocomplete="off" disabled/>
                     </div>
                     <div class="form-group col-lg-4 col-md-4 col-sm-4">
                        <span class="text-capitalize"><?php  echo FS_APARTADO;?></span>:
                        <input class="form-control" type="text" name="apartado" value="<?php echo $value1->apartado;?>" autocomplete="off" disabled/>
                     </div>
                     <div class="radio col-lg-3 col-md-3 col-sm-3">
                        <label>
                           <?php if( $value1->direccionppal ){ ?>

                           <input type="checkbox" name="direccionppal" id="direccionppal_<?php echo $value1->id;?>" value="TRUE" checked="checked" disabled/>
                           <?php }else{ ?>

                           <input type="checkbox" name="direccionppal" id="direccionppal_<?php echo $value1->id;?>" value="TRUE" disabled/>
                           <?php } ?>
                     ...
                     <div class="form-group col-lg-5 col-md-5 col-sm-5">
                        Descripción:
                        <input class="form-control" type="text" name="descripcion" value="<?php echo $value1->descripcion;?>" autocomplete="off" disabled/>
                     </div>
                  </div>
                  <div class="panel-footer text-right">
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  Ciudad:
                  <input class="form-control .departamento" type="text" name="ciudad" id="ciudad2" value="<?php echo $fsc->empresa->ciudad;?>"/>
               </div>
               <!--<div class="form-group">-->
                  <!--Código Postal:-->
